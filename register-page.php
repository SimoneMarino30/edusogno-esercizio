...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (empty($_POST["psw"])) {
    ...
    $valid_password = test_input($_POST["psw"]);
  }
  ...
  $_SESSION["register-mail"] = $new_mail;
  $_SESSION["register-name"] = $first_name;
  $_SESSION["register-surname"] = $last_name;
...
<div class="form-style">
  <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input type="password" id="password" name="psw" placeholder="Scrivila qui" required />
